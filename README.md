# engineer. architect. builder. nothing left on the table.
...
side projects nobody asked for:
- business intelligence dashboards
- encrypted credential managers
- ops control planes
...
nights: building tools for problems that keep bugging me.
